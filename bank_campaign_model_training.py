...
bucket = storage_client.bucket("gcl-ml-ops_cloudbuild")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "gcp-ml-ops.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://gcl-ml-ops_cloudbuild/bank-additional.csv"
    model_name='xgboost'
